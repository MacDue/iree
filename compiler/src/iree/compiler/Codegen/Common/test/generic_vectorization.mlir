...
// RUN: iree-opt --pass-pipeline="builtin.module(hal.executable(hal.executable.variant(builtin.module(func.func(iree-codegen-generic-vectorization{enable-vector-masking=true})))))" | FileCheck %s -check-prefix=CHECK-SCALABLE-MASK
...
// TODO: Come up with less trivial example.
