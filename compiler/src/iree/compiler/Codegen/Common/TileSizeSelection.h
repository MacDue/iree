...
public:
  ...
  SizesAndScalableFlags getDistributionTileSizes() {
    return getVectorSizesForLevel(getActualLevel(DistributionTiles));
  }

  SizesAndScalableFlags getCacheReductionSizes() {
    return getVectorSizesForLevel(getCacheReductionLevel());
  }
